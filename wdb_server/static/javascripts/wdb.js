...
(function() {
  var $source, $traceback, backsearch, breakset, breakunset, cm, cm_theme, cmd_hist, code, create_code_mirror, cwd, die, dump, e, echo, ellipsize, execute, file_cache, format_fun, get_mode, historize, init, last_cmd, log, make_ws, print, print_help, print_hist, register_handlers, searchback, searchback_stop, select, select_check, send, session_cmd_hist, start, started, suggest, suggest_stop, termscroll, time, title, to_complete, toggle_break, toggle_edition, trace, waited_for_ws, ws,
    _this = this,
