...
(function() {
  var cmd_hist, code, echo, execute, file, file_cache, persist, persistable, print, register_eval, select, title, trace, ws,
    _this = this;
  ...
  echo = function(data) {
    return $('#scrollback').append($('<span>').text(data.message));
  };
