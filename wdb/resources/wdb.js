...
(function() {
  var $sourcecode, $traceback, breakset, breakunset, check, cmd_hist, code, echo, execute, fallback, last_cmd, log, make_ws, open, print, print_hist, register_handlers, select, send, session_cmd_hist, start, started, stop, suggest, time, title, toggle_break, trace, ws, __ws_port,
    _this = this,
  ...
  execute = function(snippet) {
    var cmd, data, filename, key, space;
  ...
  suggest = function(data) {
    var $appender, $comp, added, completion, index, _i, _len, _ref, _ref1, _results;
    ...
    for (index = _i = 0, _len = _ref.length; _i < _len; index = ++_i) {
      ...
      _results.push($appender.append($('<td>').attr('title', completion.description).append($('<span>').addClass('base').text(completion.base)).append($('<span>').addClass('completion').text(completion.complete))));
    }
    return _results;
  };
