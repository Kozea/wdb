...
(function() {
  var $sourcecode, $traceback, breakset, breakunset, check, cmd_hist, code, cwd, echo, execute, fallback, format_fun, init, last_cmd, log, make_ws, open, print, print_hist, register_handlers, select, send, session_cmd_hist, start, started, stop, suggest, termscroll, time, title, toggle_break, trace, ws, __ws_port,
    _this = this,
