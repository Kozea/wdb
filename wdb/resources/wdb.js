...
(function() {
  var $sourcecode, $traceback, breakset, breakunset, check, cmd_hist, code, echo, execute, fallback, file, last_cmd, make_ws, open, print, register_handlers, select, send, start, started, stop, time, title, toggle_break, trace, ws,
    _this = this;
