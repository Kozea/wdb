...
(function() {
  ...
  suggest = function(data) {
    var $appender, $comp, completion, index, _i, _len, _ref, _results;
    ...
    for (index = _i = 0, _len = _ref.length; _i < _len; index = ++_i) {
      ...
      _results.push($appender.append($('<td>').append($('<span>').addClass('base').text(data.base)).append($('<span>').addClass('completion').text(completion))));
    }
    return _results;
  };
