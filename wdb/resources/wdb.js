...
(function() {
  var $sourcecode, $traceback, breakset, breakunset, check, cmd_hist, code, echo, execute, fallback, last_cmd, log, make_ws, open, print, register_handlers, select, send, start, started, stop, suggest, time, title, toggle_break, trace, ws, __ws_port,
    _this = this,
