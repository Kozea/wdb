...
(function() {
  var $sourcecode, $traceback, breakset, breakunset, check, cmd_hist, code, cwd, dump, echo, execute, fallback, format_fun, get_random_port, i, init, last_cmd, log, make_ws, open, print, print_help, print_hist, register_handlers, select, send, session_cmd_hist, start, started, stop, suggest, termscroll, time, title, toggle_break, trace, ws, __ws_port_index, __ws_ports, _i,
    _this = this,
