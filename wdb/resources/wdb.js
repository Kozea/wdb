...
(function() {
  var $sourcecode, $traceback, breakset, breakunset, check, cmd_hist, code, echo, execute, file, file_cache, last_cmd, make_ws, persist, persistable, print, register_handlers, select, send, start, started, stop, time, title, toggle_break, trace, ws,
    _this = this;
  ...
  select = function(data) {
    var $cur_line, $line, current_frame, lno, _i, _j, _len, _ref, _ref1, _ref2;
