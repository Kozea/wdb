...
(function() {
  ...
  select = function(data) {
    ...
    handle_file = function(file) {
      var cm, lno, _j, _ref, _ref1;

      $source.find('.CodeMirror').remove();
      $source.data('cm', cm = CodeMirror((function(elt) {
      ...
      for (lno = _j = _ref = current_frame.flno, _ref1 = current_frame.llno + 1; _ref <= _ref1 ? _j < _ref1 : _j > _ref1; lno = _ref <= _ref1 ? ++_j : --_j) {
  ...
  code = function(parent, code, classes, html) {
    ...
    if (html) {
      ...
      code_elt.add(code_elt.find('*')).contents().filter(function() {
        ...
        span = this;
        return setTimeout((function() {
          return CodeMirror.runMode($(span).text(), "python", span);
        }), 50);
      });
    } else {
      code_elt = $('<code>', {
      ...
      parent.append(code_elt);
      setTimeout((function() {
        return CodeMirror.runMode(code, "python", code_elt.get(0));
      }), 50);
    }
    return code_elt;
  };
