...
(function() {
  var $source, $traceback, backsearch, breakset, breakunset, cm, cm_theme, cmd_hist, code, create_code_mirror, cwd, dump, echo, execute, fallback, format_fun, get_random_port, historize, i, init, last_cmd, log, make_ws, open, print, print_help, print_hist, register_handlers, save, searchback, searchback_stop, select, send, session_cmd_hist, start, started, stop, suggest, suggest_stop, termscroll, time, title, toggle_break, trace, ws, __ws_port_index, __ws_ports, _i,
    _this = this,
